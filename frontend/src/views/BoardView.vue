Вот полный BoardView.vue без стилей:
vue<template>
  <div class="board-layout">
    <aside class="sidebar">
      ...
      <nav class="sidebar-nav">
        ...
        <a class="nav-item" @click="showStagesModal = true">
          <span>◈</span> Этапы
        </a>
        <a class="nav-item" @click="router.push('/todo')">
          <span>✓</span> ToDo лист
        </a>
      </nav>
...
/* Main */
.board-main { flex: 1; padding: 40px 36px; overflow-y: auto; }
.board-header {
